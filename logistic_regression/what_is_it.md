...
the line 'models the likelihood of the class memebership' means:
    - models the likelihood.... :the model dosent say this specific output belongs to this class, it gives the likehood (there  
    ...
    - class memebership: as this is a classification model, there will be different classes, so a output belongs to some class, 
